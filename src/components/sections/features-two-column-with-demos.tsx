...
export function Feature({
  ...
  return (
    <div
      className={clsx(
        "rounded-lg bg-mist-950/2.5 p-2 dark:bg-white/5",
        className,
      )}
    >
      ...
      <div className="flex flex-col gap-4 p-6 sm:p-10 lg:p-6">
        <div>
          <h3 className="text-base/8 font-medium text-mist-950 dark:text-white">
            {headline}
          </h3>
          <div className="mt-2 flex flex-col gap-4 text-sm/7 text-mist-700 dark:text-mist-400">
            {subheadline}
          </div>
        </div>
        {cta && <>{cta}</>}
